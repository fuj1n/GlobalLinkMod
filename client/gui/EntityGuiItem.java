...
public class EntityGuiItem extends EntityItem
{
    ...
    public EntityGuiItem(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.health = 5;
    ...
    public EntityGuiItem(World par1World, double par2, double par4, double par6, ItemStack par8ItemStack)
    {
    ...
    public EntityGuiItem(World par1World)
    {
        super(par1World);
        this.health = 5;
        this.hoverStart = (float)(Math.random() * Math.PI * 2.0D);
